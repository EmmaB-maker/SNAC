...
flowScheduler.add(new1RoutineBegin());
flowScheduler.add(new1RoutineEachFrame());
flowScheduler.add(new1RoutineEnd());
flowScheduler.add(small_imageRoutineBegin());
flowScheduler.add(small_imageRoutineEachFrame());
flowScheduler.add(small_imageRoutineEnd());
flowScheduler.add(medium_imageRoutineBegin());
flowScheduler.add(medium_imageRoutineEachFrame());
flowScheduler.add(medium_imageRoutineEnd());
flowScheduler.add(medium2_imageRoutineBegin());
flowScheduler.add(medium2_imageRoutineEachFrame());
flowScheduler.add(medium2_imageRoutineEnd());
flowScheduler.add(large_imageRoutineBegin());
flowScheduler.add(large_imageRoutineEachFrame());
flowScheduler.add(large_imageRoutineEnd());
...
psychoJS.start({
  ...
  resources: [
    ...
    {'name': 'high arousal urban/Billings_0295.JPG', 'path': 'high arousal urban/Billings_0295.JPG'},
    ...
    {'name': 'high arousal nature/Berman_Nature__19.jpg', 'path': 'high arousal nature/Berman_Nature__19.jpg'},
    {'name': 'low arousal nature/BotanicGardens_0497.JPG', 'path': 'low arousal nature/BotanicGardens_0497.JPG'},
    {'name': 'high arousal urban/Downtown_0341.jpg', 'path': 'high arousal urban/Downtown_0341.jpg'},
    {'name': 'low arousal urban/16thStreetMall_0813.JPG', 'path': 'low arousal urban/16thStreetMall_0813.JPG'},
    {'name': 'high arousal nature/Vacation_7596.JPG', 'path': 'high arousal nature/Vacation_7596.JPG'},
    {'name': 'high arousal nature/Hyalite_0236.JPG', 'path': 'high arousal nature/Hyalite_0236.JPG'},
    ...
    {'name': 'high arousal urban/CO_Blvrd (41).jpg', 'path': 'high arousal urban/CO_Blvrd (41).jpg'},
    {'name': 'high arousal urban/Urban_Berman_32.jpg', 'path': 'high arousal urban/Urban_Berman_32.jpg'},
    {'name': 'low arousal nature/Vacation_1925.JPG', 'path': 'low arousal nature/Vacation_1925.JPG'},
    {'name': 'high arousal urban/Downtown_0306.jpg', 'path': 'high arousal urban/Downtown_0306.jpg'},
    ...
    {'name': 'low arousal nature/31L.jpg', 'path': 'low arousal nature/31L.jpg'},
    {'name': 'high arousal urban/DU (19).jpg', 'path': 'high arousal urban/DU (19).jpg'},
    {'name': 'low arousal urban/Vacation_8420.JPG', 'path': 'low arousal urban/Vacation_8420.JPG'},
    {'name': 'high arousal urban/Billings_0310.JPG', 'path': 'high arousal urban/Billings_0310.JPG'},
    {'name': 'low arousal nature/24L.jpg', 'path': 'low arousal nature/24L.jpg'},
    {'name': 'low arousal urban/Downtown_0390.jpg', 'path': 'low arousal urban/Downtown_0390.jpg'},
    {'name': 'low arousal nature/Vacation_7080.JPG', 'path': 'low arousal nature/Vacation_7080.JPG'},
    {'name': 'high arousal nature/Berman_Nature__41.jpg', 'path': 'high arousal nature/Berman_Nature__41.jpg'},
    {'name': 'low arousal nature/Vacation_7996.JPG', 'path': 'low arousal nature/Vacation_7996.JPG'},
    {'name': 'low arousal nature/GotG_0053.jpg', 'path': 'low arousal nature/GotG_0053.jpg'},
    {'name': 'high arousal urban/Golden (47).jpg', 'path': 'high arousal urban/Golden (47).jpg'},
    {'name': 'high arousal urban/Downtown_0354.jpg', 'path': 'high arousal urban/Downtown_0354.jpg'},
    {'name': 'high arousal urban/DTC (12).jpg', 'path': 'high arousal urban/DTC (12).jpg'},
    {'name': 'high arousal urban/CO_Blvrd (3).jpg', 'path': 'high arousal urban/CO_Blvrd (3).jpg'},
    {'name': 'high arousal nature/Berman_Nature__17.jpg', 'path': 'high arousal nature/Berman_Nature__17.jpg'},
    {'name': 'low arousal urban/Downtown_0381.jpg', 'path': 'low arousal urban/Downtown_0381.jpg'},
    {'name': 'high arousal nature/Vacation_5473.JPG', 'path': 'high arousal nature/Vacation_5473.JPG'},
    {'name': 'low arousal nature/39H.jpg', 'path': 'low arousal nature/39H.jpg'},
    {'name': 'high arousal nature/Berman_Nature__34.jpg', 'path': 'high arousal nature/Berman_Nature__34.jpg'},
    {'name': 'high arousal urban/Billings_0243.JPG', 'path': 'high arousal urban/Billings_0243.JPG'},
    {'name': 'low arousal urban/DTC (50).jpg', 'path': 'low arousal urban/DTC (50).jpg'},
    {'name': 'low arousal urban/Golden (49).jpg', 'path': 'low arousal urban/Golden (49).jpg'},
    {'name': 'high arousal urban/Downtown_0330.jpg', 'path': 'high arousal urban/Downtown_0330.jpg'},
    {'name': 'low arousal urban/Bozeman_0005.JPG', 'path': 'low arousal urban/Bozeman_0005.JPG'},
    {'name': 'low arousal nature/31H.jpg', 'path': 'low arousal nature/31H.jpg'},
    {'name': 'high arousal nature/BotanicGardens_0059.JPG', 'path': 'high arousal nature/BotanicGardens_0059.JPG'},
    {'name': 'high arousal urban/Downtown_0345.jpg', 'path': 'high arousal urban/Downtown_0345.jpg'},
    ...
    {'name': 'high arousal urban/Urban_Berman_19.jpg', 'path': 'high arousal urban/Urban_Berman_19.jpg'},
    {'name': 'low arousal nature/Vacation_7034.JPG', 'path': 'low arousal nature/Vacation_7034.JPG'},
    {'name': 'low arousal urban/Golden (33).jpg', 'path': 'low arousal urban/Golden (33).jpg'},
    {'name': 'high arousal nature/Vacation_0924.JPG', 'path': 'high arousal nature/Vacation_0924.JPG'},
    {'name': 'high arousal nature/Vacation_5663.JPG', 'path': 'high arousal nature/Vacation_5663.JPG'},
    {'name': 'low arousal urban/Urban_Berman_35.jpg', 'path': 'low arousal urban/Urban_Berman_35.jpg'},
    {'name': 'high arousal nature/Berman_Nature__46.jpg', 'path': 'high arousal nature/Berman_Nature__46.jpg'},
    {'name': 'high arousal nature/Vacation_2695.JPG', 'path': 'high arousal nature/Vacation_2695.JPG'},
    {'name': 'low arousal urban/Vacation_5135.JPG', 'path': 'low arousal urban/Vacation_5135.JPG'},
    {'name': 'high arousal nature/Vacation_5665.JPG', 'path': 'high arousal nature/Vacation_5665.JPG'},
    {'name': 'high arousal nature/Vacation_5756.JPG', 'path': 'high arousal nature/Vacation_5756.JPG'},
    {'name': 'high arousal urban/CO_Blvrd (12).jpg', 'path': 'high arousal urban/CO_Blvrd (12).jpg'},
    ...
    {'name': 'high arousal urban/Billings_0285.JPG', 'path': 'high arousal urban/Billings_0285.JPG'},
    {'name': 'low arousal nature/Aquarium_0442.JPG', 'path': 'low arousal nature/Aquarium_0442.JPG'},
    {'name': 'high arousal nature/BotanicGardens_0893.JPG', 'path': 'high arousal nature/BotanicGardens_0893.JPG'},
    {'name': 'high arousal nature/Ranch (5).jpeg', 'path': 'high arousal nature/Ranch (5).jpeg'},
    {'name': 'low arousal urban/16thStreetMall_0744.JPG', 'path': 'low arousal urban/16thStreetMall_0744.JPG'},
    {'name': 'high arousal urban/CO_Blvrd (11).jpg', 'path': 'high arousal urban/CO_Blvrd (11).jpg'},
    {'name': 'low arousal nature/04H.jpg', 'path': 'low arousal nature/04H.jpg'},
    {'name': 'high arousal urban/Golden (40).jpg', 'path': 'high arousal urban/Golden (40).jpg'},
    {'name': 'high arousal nature/Hyalite_0084.JPG', 'path': 'high arousal nature/Hyalite_0084.JPG'},
    {'name': 'low arousal urban/Vacation_5018.JPG', 'path': 'low arousal urban/Vacation_5018.JPG'},
    {'name': 'low arousal urban/Golden (55).jpg', 'path': 'low arousal urban/Golden (55).jpg'},
    {'name': 'low arousal nature/Hyalite_0093.JPG', 'path': 'low arousal nature/Hyalite_0093.JPG'},
    {'name': 'low arousal urban/16thStreetMall_0838.JPG', 'path': 'low arousal urban/16thStreetMall_0838.JPG'},
    {'name': 'high arousal urban/CO_Blvrd (14).jpg', 'path': 'high arousal urban/CO_Blvrd (14).jpg'},
    {'name': 'low arousal nature/GotG_0060.jpg', 'path': 'low arousal nature/GotG_0060.jpg'},
    {'name': 'low arousal nature/20L.jpg', 'path': 'low arousal nature/20L.jpg'},
    {'name': 'high arousal nature/Vacation_5469.JPG', 'path': 'high arousal nature/Vacation_5469.JPG'},
    ...
    {'name': 'high arousal nature/Berman_Nature__17.jpg', 'path': 'high arousal nature/Berman_Nature__17.jpg'},
    {'name': 'low arousal nature/BotanicGardens_0836.JPG', 'path': 'low arousal nature/BotanicGardens_0836.JPG'},
...
var text_8;
var key_resp_2;
var small_imageClock;
var image_2;
var text_3;
var medium_imageClock;
var image_3;
var text_4;
var medium2_imageClock;
var image_5;
var text_5;
var large_imageClock;
var image_4;
var text_6;
var newClock;
var text_7;
...
async function experimentInit() {
  // Initialize components for Routine "new1"
  new1Clock = new util.Clock();
  text_8 = new visual.TextStim({
    win: psychoJS.window,
    name: 'text_8',
    text: 'Please click the spacebar to see the experimental image sizes!',
    font: 'Arial',
    units: 'norm', 
  ...
  // Initialize components for Routine "small_image"
  small_imageClock = new util.Clock();
  image_2 = new visual.ImageStim({
    win : psychoJS.window,
    name : 'image_2', units : 'norm', 
    image : 'high arousal nature/Berman_Nature__17.jpg', mask : undefined,
    anchor : 'center',
    ori : 0.0, 
    pos : [0, 0], 
    draggable: false,
  ...
  // Initialize components for Routine "medium_image"
  medium_imageClock = new util.Clock();
  ...
  // Initialize components for Routine "medium2_image"
  medium2_imageClock = new util.Clock();
  image_5 = new visual.ImageStim({
    win : psychoJS.window,
    name : 'image_5', units : 'norm', 
    image : 'high arousal nature/Berman_Nature__17.jpg', mask : undefined,
    anchor : 'center',
    ori : 0.0, 
    pos : [0, 0], 
  ...
  // Initialize components for Routine "large_image"
  large_imageClock = new util.Clock();
  ...
  text_7 = new visual.TextStim({
    win: psychoJS.window,
    name: 'text_7',
    text: 'Please let me know which size you liked: \n\n1, 2, 3, or 4',
    font: 'Arial',
    units: 'norm', 
  ...
  image_6 = new visual.ImageStim({
    ...
    image : 'low arousal nature/BotanicGardens_0836.JPG', mask : undefined,
    anchor : 'center',
    ori : 0.0, 
    pos : [0, 0], 
    draggable: false,
...
var frameN;
var continueRoutine;
var new1MaxDurationReached;
var _key_resp_2_allKeys;
var new1MaxDuration;
var new1Components;
function new1RoutineBegin(snapshot) {
  return async function () {
    TrialHandler.fromSnapshot(snapshot); // ensure that .thisN vals are up to date
    
    //--- Prepare to start Routine 'new1' ---
    t = 0;
    frameN = -1;
    continueRoutine = true; // until we're told otherwise
    new1Clock.reset();
    routineTimer.reset();
    new1MaxDurationReached = false;
    // update component parameters for each repeat
    key_resp_2.keys = undefined;
    key_resp_2.rt = undefined;
    _key_resp_2_allKeys = [];
    psychoJS.experiment.addData('new1.started', globalClock.getTime());
    new1MaxDuration = null
    // keep track of which components have finished
    new1Components = [];
    new1Components.push(text_8);
    new1Components.push(key_resp_2);
    
    for (const thisComponent of new1Components)
...
function new1RoutineEachFrame() {
  return async function () {
    //--- Loop for each frame of Routine 'new1' ---
    // get current time
    t = new1Clock.getTime();
...
function new1RoutineEnd(snapshot) {
  return async function () {
    //--- Ending Routine 'new1' ---
    for (const thisComponent of new1Components) {
    ...
    psychoJS.experiment.addData('new1.stopped', globalClock.getTime());
    ...
    key_resp_2.stop();
    // the Routine "new1" was not non-slip safe, so reset the non-slip timer
    routineTimer.reset();
...
var small_imageMaxDurationReached;
var small_imageMaxDuration;
var small_imageComponents;
function small_imageRoutineBegin(snapshot) {
  return async function () {
    TrialHandler.fromSnapshot(snapshot); // ensure that .thisN vals are up to date
    
    //--- Prepare to start Routine 'small_image' ---
    t = 0;
    frameN = -1;
    continueRoutine = true; // until we're told otherwise
    small_imageClock.reset(routineTimer.getTime());
    routineTimer.add(1.000000);
    small_imageMaxDurationReached = false;
    // update component parameters for each repeat
    psychoJS.experiment.addData('small_image.started', globalClock.getTime());
    small_imageMaxDuration = null
    // keep track of which components have finished
    small_imageComponents = [];
    small_imageComponents.push(image_2);
    small_imageComponents.push(text_3);
    
    for (const thisComponent of small_imageComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
var frameRemains;
function small_imageRoutineEachFrame() {
  return async function () {
    //--- Loop for each frame of Routine 'small_image' ---
    // get current time
    t = small_imageClock.getTime();
    frameN = frameN + 1;// number of completed frames (so 0 is the first frame)
    // update/draw components on each frame
...
function small_imageRoutineEnd(snapshot) {
  return async function () {
    //--- Ending Routine 'small_image' ---
    for (const thisComponent of small_imageComponents) {
      if (typeof thisComponent.setAutoDraw === 'function') {
        thisComponent.setAutoDraw(false);
      }
    }
    psychoJS.experiment.addData('small_image.stopped', globalClock.getTime());
    if (small_imageMaxDurationReached) {
        small_imageClock.add(small_imageMaxDuration);
    } else {
        small_imageClock.add(1.000000);
    }
    // Routines running outside a loop should always advance the datafile row
    if (currentLoop === psychoJS.experiment) {
      psychoJS.experiment.nextEntry(snapshot);
...
var medium_imageMaxDurationReached;
var medium_imageMaxDuration;
var medium_imageComponents;
function medium_imageRoutineBegin(snapshot) {
  return async function () {
    TrialHandler.fromSnapshot(snapshot); // ensure that .thisN vals are up to date
    
    //--- Prepare to start Routine 'medium_image' ---
    t = 0;
    frameN = -1;
    continueRoutine = true; // until we're told otherwise
    medium_imageClock.reset(routineTimer.getTime());
    routineTimer.add(1.000000);
    medium_imageMaxDurationReached = false;
    // update component parameters for each repeat
    psychoJS.experiment.addData('medium_image.started', globalClock.getTime());
    medium_imageMaxDuration = null
    // keep track of which components have finished
    medium_imageComponents = [];
    medium_imageComponents.push(image_3);
    medium_imageComponents.push(text_4);
    
    for (const thisComponent of medium_imageComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function medium_imageRoutineEachFrame() {
  return async function () {
    //--- Loop for each frame of Routine 'medium_image' ---
    // get current time
    t = medium_imageClock.getTime();
    frameN = frameN + 1;// number of completed frames (so 0 is the first frame)
    // update/draw components on each frame
...
function medium_imageRoutineEnd(snapshot) {
  return async function () {
    //--- Ending Routine 'medium_image' ---
    for (const thisComponent of medium_imageComponents) {
      if (typeof thisComponent.setAutoDraw === 'function') {
        thisComponent.setAutoDraw(false);
      }
    }
    psychoJS.experiment.addData('medium_image.stopped', globalClock.getTime());
    if (medium_imageMaxDurationReached) {
        medium_imageClock.add(medium_imageMaxDuration);
    } else {
        medium_imageClock.add(1.000000);
    }
    // Routines running outside a loop should always advance the datafile row
    if (currentLoop === psychoJS.experiment) {
      psychoJS.experiment.nextEntry(snapshot);
...
var medium2_imageMaxDurationReached;
var medium2_imageMaxDuration;
var medium2_imageComponents;
function medium2_imageRoutineBegin(snapshot) {
  return async function () {
    TrialHandler.fromSnapshot(snapshot); // ensure that .thisN vals are up to date
    
    //--- Prepare to start Routine 'medium2_image' ---
    t = 0;
    frameN = -1;
    continueRoutine = true; // until we're told otherwise
    medium2_imageClock.reset(routineTimer.getTime());
    routineTimer.add(1.000000);
    medium2_imageMaxDurationReached = false;
    // update component parameters for each repeat
    psychoJS.experiment.addData('medium2_image.started', globalClock.getTime());
    medium2_imageMaxDuration = null
    // keep track of which components have finished
    medium2_imageComponents = [];
    medium2_imageComponents.push(image_5);
    medium2_imageComponents.push(text_5);
    
    for (const thisComponent of medium2_imageComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function medium2_imageRoutineEachFrame() {
  return async function () {
    //--- Loop for each frame of Routine 'medium2_image' ---
    // get current time
    t = medium2_imageClock.getTime();
    frameN = frameN + 1;// number of completed frames (so 0 is the first frame)
    // update/draw components on each frame
...
function medium2_imageRoutineEnd(snapshot) {
  return async function () {
    //--- Ending Routine 'medium2_image' ---
    for (const thisComponent of medium2_imageComponents) {
      if (typeof thisComponent.setAutoDraw === 'function') {
        thisComponent.setAutoDraw(false);
      }
    }
    psychoJS.experiment.addData('medium2_image.stopped', globalClock.getTime());
    if (medium2_imageMaxDurationReached) {
        medium2_imageClock.add(medium2_imageMaxDuration);
    } else {
        medium2_imageClock.add(1.000000);
    }
    // Routines running outside a loop should always advance the datafile row
    if (currentLoop === psychoJS.experiment) {
      psychoJS.experiment.nextEntry(snapshot);
...
var large_imageMaxDurationReached;
var large_imageMaxDuration;
var large_imageComponents;
function large_imageRoutineBegin(snapshot) {
  return async function () {
    TrialHandler.fromSnapshot(snapshot); // ensure that .thisN vals are up to date
    
    //--- Prepare to start Routine 'large_image' ---
    t = 0;
    frameN = -1;
    continueRoutine = true; // until we're told otherwise
    large_imageClock.reset(routineTimer.getTime());
    routineTimer.add(1.000000);
    large_imageMaxDurationReached = false;
    // update component parameters for each repeat
    psychoJS.experiment.addData('large_image.started', globalClock.getTime());
    large_imageMaxDuration = null
    // keep track of which components have finished
    large_imageComponents = [];
    large_imageComponents.push(image_4);
    large_imageComponents.push(text_6);
    
    for (const thisComponent of large_imageComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function large_imageRoutineEachFrame() {
  return async function () {
    //--- Loop for each frame of Routine 'large_image' ---
    // get current time
    t = large_imageClock.getTime();
    frameN = frameN + 1;// number of completed frames (so 0 is the first frame)
    // update/draw components on each frame
...
function large_imageRoutineEnd(snapshot) {
  return async function () {
    //--- Ending Routine 'large_image' ---
    for (const thisComponent of large_imageComponents) {
      if (typeof thisComponent.setAutoDraw === 'function') {
        thisComponent.setAutoDraw(false);
      }
    }
    psychoJS.experiment.addData('large_image.stopped', globalClock.getTime());
    if (large_imageMaxDurationReached) {
        large_imageClock.add(large_imageMaxDuration);
    } else {
        large_imageClock.add(1.000000);
    }
    // Routines running outside a loop should always advance the datafile row
    if (currentLoop === psychoJS.experiment) {
      psychoJS.experiment.nextEntry(snapshot);
...
function newRoutineBegin(snapshot) {
  return async function () {
    ...
    frameN = -1;
    continueRoutine = true; // until we're told otherwise
    newClock.reset(routineTimer.getTime());
    ...
    // keep track of which components have finished
    newComponents = [];
    newComponents.push(text_7);
    
    for (const thisComponent of newComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function newRoutineEnd(snapshot) {
  return async function () {
    ...
    if (newMaxDurationReached) {
        newClock.add(newMaxDuration);
    } else {
        newClock.add(3.000000);
    }
    // Routines running outside a loop should always advance the datafile row
    if (currentLoop === psychoJS.experiment) {
      psychoJS.experiment.nextEntry(snapshot);
...
function start_pRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of start_pComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function p_equationRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of p_equationComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function p_imageRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of p_imageComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function p_math_answerRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of p_math_answerComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function p_time_startRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of p_time_startComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function p_time_endRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of p_time_endComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function p_vastnessRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of p_vastnessComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function start_eRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of start_eComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function equationsRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of equationsComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function equationsRoutineEnd(snapshot) {
  return async function () {
    ...
    // the Routine "equations" was not non-slip safe, so reset the non-slip timer
    routineTimer.reset();
...
function math_answerRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of math_answerComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function time_endRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of time_endComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function vastnessRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of vastnessComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function vastnessRoutineEnd(snapshot) {
  return async function () {
    ...
    psychoJS.experiment.addData('vast_answer.rt', vast_answer.getRT());
    // store data for psychoJS.experiment (ExperimentHandler)
